...
//         {/* Card Body */}
//         <div className={`card-body p-0 py-2 ${theme ==="dark"?"dark":"light"}  `}>
...
function Card() {
  ...
  return (
    <div className="cardContainer card1">
      <div
        className="card shadow-sm mb-4 border-0 rounded-4 bg-danger"
      ...
      >
        ...
        <div className={`card-body p-0 py-2 ${theme === "dark" ? "dark" : "light"}`}>
          {/* Title with two-line truncation */}
          <h5 className="card-title text-truncate-2 p-1">
