        ...
        <div>
          ...
          <div className="aroundTheWorld mt-4">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
              ...
              {/* <div className="d-flex gap-2">
                {["All", "Business", "Sports", "World"].map((category) => (
                  <span
                    key={category}
                    className={`tabLink ${activeCategory === category ? "active" : ""}`}
          ...
          <div className="lifeStyle mt-4">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
              ...
              {/* <div className="d-flex gap-2">
                {["All", "Fashion", "Food", "Health", "Travel"].map((category) => (
                  <span
                    key={category}
                    className={`tabLink ${activeCategory2 === category ? "active" : ""}`}
            ...
            <div className="row transition-container">
              {aroundTheWorldData.slice(0, 4).map((item) => (
                <div key={item.id} className="col-md-6 col-12 mb-3">
                  <div className="card border-0 shadow-sm">
                    <div className="position-relative">
                      <Image
                        src={item.imgSrc}
      ...
      <div className="col-lg-4 col-12 my-4 ps-3 pe-3 rightColumn">
        ...
        <div className="followUs">
          <div className="mb-4 underlin d-flex justify-content-between gap-3">
            <button className="btn btn-outline-primary w-50">Follow Us</button>
        ...
        <div className="advertisment">
          <div className="my-4">
            <div className="imgContainer position-relative">
              ...
              />
              <div className={`${theme === "dark" ? "overlay" : ""}`}></div>
            </div>
          </div>
        </div>
