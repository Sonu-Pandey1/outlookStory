...
// Sample Data (Updated to include imgSrc for all items)
const latestPoastData = [
  // Data for Entertainment
  {
    id: 1,
...
const popularPostData = [
  ...
  },
  {
    ...
    category: "Business",
    title: "Cryptocurrency Adoption Grows Despite Market Volatility",
    imgSrc: "https://jnews.io/magazine/wp-content/uploads/sites/34/2017/12/jnews-demo-3-750x536.jpg", // Added imgSrc
  },
  {
    id: 5,
    category: "Business",
...
const recommendedData = [
  ...
  },
  {
    id: 2,
    category: "Stories",
    title: "Netflix Introduces a Cheaper Subscription Plan With Ads office.",
    imgSrc:
      "https://jnews.io/magazine/wp-content/uploads/sites/34/2017/12/jnews-demo-20-350x250.jpg",
  },
  {
...
export default function LatestPopularPosts({ categoryC,category }) {
  ...
  // Filter posts based on categoryC
  const filteredLatestPosts = latestPoastData.filter(
    (post) => post.category === categoryC
  );

  const filteredPopularPosts = popularPostData.filter(
    (post) => post.category === categoryC
  );

  const filteredAroundTheWorld = recommendedData.filter(
    (post) => post.category === categoryC
  );
